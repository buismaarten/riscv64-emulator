...
void test_inst32() {
    for (uint32_t i = 0; i < sizeof(program32) / sizeof(program32[0]); i++) {
        ...
        if (OP_ADD(inst)) {
            int32_t rs2 = EXTRACT_BITS(inst, 20, 5);
            int32_t rs1 = EXTRACT_BITS(inst, 15, 5);
            int32_t rd = EXTRACT_BITS(inst, 7, 5);
        ...
        if (OP_ADDI(inst)) {
            int32_t imm = EXTRACT_BITS(inst, 20, 12);
            int32_t rs1 = EXTRACT_BITS(inst, 15, 5);
            int32_t rd = EXTRACT_BITS(inst, 7, 5);
        ...
        if (OP_AMOADD_D(inst)) {
            int32_t aq = EXTRACT_BITS(inst, 26, 1);
            int32_t rl = EXTRACT_BITS(inst, 25, 1);
            int32_t rs2 = EXTRACT_BITS(inst, 20, 5);
            int32_t rs1 = EXTRACT_BITS(inst, 15, 5);
            int32_t rd = EXTRACT_BITS(inst, 7, 5);
        ...
        if (OP_AUIPC(inst)) {
            int32_t imm = EXTRACT_BITS(inst, 12, 20);
            int32_t rd = EXTRACT_BITS(inst, 7, 5);
        ...
        if (OP_CSRRC(inst)) {
            int32_t csr = EXTRACT_BITS(inst, 20, 12);
            int32_t rs1 = EXTRACT_BITS(inst, 15, 5);
            int32_t rd = EXTRACT_BITS(inst, 7, 5);
        ...
        if (OP_CSRRSI(inst)) {
            int32_t csr = EXTRACT_BITS(inst, 20, 12);
            int32_t uimm = EXTRACT_BITS(inst, 15, 5);
            int32_t rd = EXTRACT_BITS(inst, 7, 5);
        ...
        if (OP_FADD_D(inst)) {
            int32_t rs2 = EXTRACT_BITS(inst, 20, 5);
            int32_t rs1 = EXTRACT_BITS(inst, 15, 5);
            int32_t rm = EXTRACT_BITS(inst, 12, 3);
            int32_t rd = EXTRACT_BITS(inst, 7, 5);
        ...
        if (OP_FMADD_D(inst)) {
            int32_t rs3 = EXTRACT_BITS(inst, 27, 5);
            int32_t rs2 = EXTRACT_BITS(inst, 20, 5);
            int32_t rs1 = EXTRACT_BITS(inst, 15, 5);
            int32_t rm = EXTRACT_BITS(inst, 12, 3);
            int32_t rd = EXTRACT_BITS(inst, 7, 5);
        ...
        if (OP_SB(inst)) {
            ...
            offset += EXTRACT_BITS(inst, 25, 7) << 5;
            offset |= EXTRACT_BITS(inst, 7, 5);
        ...
        if (OP_SLLI(inst)) {
            int32_t shamt = EXTRACT_BITS(inst, 20, 5);
            int32_t rs1 = EXTRACT_BITS(inst, 15, 5);
            int32_t rd = EXTRACT_BITS(inst, 7, 5);
        ...
        if (OP_SRLI(inst)) {
            int32_t shamt = EXTRACT_BITS(inst, 20, 6);
            int32_t rs1 = EXTRACT_BITS(inst, 15, 5);
            int32_t rd = EXTRACT_BITS(inst, 7, 5);

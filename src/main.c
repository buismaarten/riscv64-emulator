...
#define OP_C_ADDW(inst)      (OP_C(inst) == 0b01 && OP_C_FUNCT4(inst) == 0b1001 && OP_C_RS1_TWO(inst) == 0b11 && OP_C_RS2_TWO(inst) == 0b01)
#define OP_C_AND(inst)       (OP_C(inst) == 0b01 && OP_C_FUNCT4(inst) == 0b1000 && OP_C_RS1_TWO(inst) == 0b11 && OP_C_RS2_TWO(inst) == 0b11)
#define OP_C_ANDI(inst)      (OP_C(inst) == 0b01 && OP_C_FUNCT3(inst) == 0b100 && OP_C_RS1_TWO(inst) == 0b10)
...
#define OP_C_OR(inst)        (OP_C(inst) == 0b01 && OP_C_FUNCT4(inst) == 0b1000 && OP_C_RS1_TWO(inst) == 0b11 && OP_C_RS2_TWO(inst) == 0b10)
...
#define OP_C_XOR(inst)       (OP_C(inst) == 0b01 && OP_C_FUNCT4(inst) == 0b1000 && OP_C_RS1_TWO(inst) == 0b11 && OP_C_RS2_TWO(inst) == 0b01)
